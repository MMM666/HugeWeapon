...
public class IHW_ModelMoonLight extends IHW_ModelBase {
	...
	public IHW_ModelMoonLight() {
		...
		fBladePadding1.setTextureOffset(0, 0).addBox(-1.0F, -3.0F, 0.0F, 2, 3, 4, 0.05F);
		...
		fBladePadding2.setTextureOffset(0, 0).addBox(-1.0F, -1.0F, 0.0F, 2, 2, 4, 0.05F);
		fBladePadding2.setRotationPoint(0.0F, 1.0F, 4.5F);
		
		fBladePadding3 = new MMM_ModelRenderer(this);
		fBladePadding3.setTextureOffset(0, 0).addBox(-1.0F, .0F, 0.0F, 2, 2, 4, 0.05F);
		...
		fBladePadding4.setTextureOffset(0, 0).addBox(-1.0F, .0F, 0.0F, 2, 2, 4, 0.05F);
		...
		fBladePadding5.setTextureOffset(0, 0).addBox(-1.0F, .0F, 0.0F, 2, 2, 4, 0.05F);
		...
		fBladePadding6.setTextureOffset(0, 0).addBox(-1.0F, .0F, 0.0F, 2, 2, 4, 0.05F);
		fBladePadding6.setRotationPoint(0.0F, 8.0F, 0.0F);
		fBladePadding6.setRotateAngleDegX(6F);
		
		
		fBlade1 = new MMM_ModelRenderer(this);
		fBlade1.setTextureOffset(0, 0).addBox(-1.0F, -6.0F, 0.0F, 2, 6, 2);
		fBlade1.setTextureOffset(0, 0).addBox(-1.0F, -2.5F, -0.8F, 2, 1, 1, 0.2F);
		fBlade1.setTextureOffset(0, 0).addBox(-0.5F, -7.5F, 2.0F, 1, 7, 3);
		fBlade1.setRotationPoint(0.0F, -1.0F, 0.0F);
		fBlade1.setRotateAngleDegX(-15F);
		
		fBlade2 = new MMM_ModelRenderer(this);
		fBlade2.setTextureOffset(0, 0).addBox(-1.0F, 0.0F, 0.0F, 2, 6, 2);
		fBlade2.setTextureOffset(0, 0).addBox(-1.0F, 1.5F, -0.8F, 2, 1, 1, 0.3F);
		...
		fBlade3.setTextureOffset(0, 0).addBox(-1.0F, 0.0F, 0.0F, 2, 6, 2);
		fBlade3.setTextureOffset(0, 0).addBox(-1.0F, 2.0F, -0.8F, 2, 1, 1, 0.3F);
		fBlade3.setTextureOffset(0, 0).addBox(-0.5F, 0.0F, 2.0F, 1, 6, 3);
		fBlade3.setRotationPoint(0.0F, 2.0F, 0.0F);
		fBlade3.setRotateAngleDegX(11F);
		
		fBlade4 = new MMM_ModelRenderer(this);
		fBlade4.setTextureOffset(0, 0).addBox(-1.0F, 0.0F, 0.0F, 2, 7, 2);
		fBlade4.setTextureOffset(0, 0).addBox(-1.0F, 3.0F, -0.8F, 2, 1, 1, 0.3F);
		fBlade4.setTextureOffset(0, 0).addBox(-0.5F, 0.0F, 2.0F, 1, 7, 3);
		fBlade4.setRotationPoint(0.0F, 2.0F, 0.0F);
		fBlade4.setRotateAngleDegX(8F);
		
		fBlade5 = new MMM_ModelRenderer(this);
		fBlade5.setTextureOffset(0, 0).addBox(-1.0F, 0.0F, 0.0F, 2, 8, 2);
		fBlade5.setTextureOffset(0, 0).addBox(-1.0F, 3.0F, -0.8F, 2, 1, 1, 0.3F);
		fBlade5.setTextureOffset(0, 0).addBox(-0.5F, 0.0F, 2.0F, 1, 9, 3);
		fBlade5.setRotationPoint(0.0F, 2.0F, 0.0F);
		fBlade5.setRotateAngleDegX(6F);
		
		fGrip = new MMM_ModelRenderer(this);
		fGrip.setTextureOffset(0, 0).addBox(-0.5F, -2.0F, -1.0F, 1, 6, 2, -0.2F);
		fGrip.setTextureOffset(0, 0).addBox(-1.0F, 3.0F, -1.0F, 2, 2, 3, 0.0F);
		fGrip.setTextureOffset(0, 0).addBox(-1.0F, -2.0F, 2.0F, 2, 7, 2, 0.1F);
		fGrip.setTextureOffset(0, 0).addBox(-1.0F, -4.0F, -1.0F, 2, 2, 4, 0.1F);
		fGrip.setTextureOffset(0, 0).addBox(-0.5F, -5.0F, 3.0F, 1, 3, 1, 0.1F);
		
		fRod = new MMM_ModelRenderer(this);
		fRod.setTextureOffset(0, 0).addBox(-0.5F, -4.0F, -0.5F, 1, 5, 1);
		...
		fBeam1.setTextureOffset(0, 0).addPlate(0.7F, -7.5F, 2.0F, 5, 7, 1);
		fBeam1.setTextureOffset(0, 0).addPlate(-0.7F, -7.5F, 2.0F, 5, 7, 5);
		...
		fBeam2.setTextureOffset(0, 0).addPlate(0.7F, 0.5F, 2.0F, 5, 5, 1);
		fBeam2.setTextureOffset(0, 0).addPlate(-0.7F, 0.5F, 2.0F, 5, 5, 5);
		...
		fBeam3.setTextureOffset(0, 0).addPlate(0.7F, 0.0F, 2.0F, 5, 6, 1);
		fBeam3.setTextureOffset(0, 0).addPlate(-0.7F, 0.0F, 2.0F, 5, 6, 5);
		...
		fBeam4.setTextureOffset(0, 0).addPlate(0.7F, 0.0F, 2.0F, 5, 7, 1);
		fBeam4.setTextureOffset(0, 0).addPlate(-0.7F, 0.0F, 2.0F, 5, 7, 5);
		...
		fBeam5.setTextureOffset(0, 0).addPlate(0.7F, 0.0F, 2.0F, 5, 9, 1);
		fBeam5.setTextureOffset(0, 0).addPlate(-0.7F, 0.0F, 2.0F, 5, 9, 5);
